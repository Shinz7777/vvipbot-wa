...
const BotName = 'FZLAGTHBOT'; 
const instagram = 'agus_alnsyh71- fazaal21_'; 
const aktif = '06:00-23:30';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Fazal\n' // Nama kamu
            + 'ORG:FZLAGTHBOT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6285695157547:+62 856-9515-7547\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
//Hay gay
//create @fazaal21_ don't delate this please
